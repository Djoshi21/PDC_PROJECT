...
{
for(int i=0;i<p;++i)
m[i]=0.0; // initializing means to 0
int cnt=0;
for(int i=0;i<p;++i)
{
cnt=0;
...
public static ArrayList<Double> main(ArrayList<Integer> inputs, int numberOfClustersNeeded)
{
...
ArrayList returningList = new ArrayList<Double>();
returningList.addAll(Arrays.asList(m));
