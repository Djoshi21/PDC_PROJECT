...
public class KMeansClusteringJob {
	...
	final static int totalClusters = 2;
	final static int minX = 2;
	final static int maxX = 500;
	...
	public static void main(String[] args) throws IOException,InterruptedException, ClassNotFoundException {
		...
		centerWriter.append(new ClusterCenter(new Vector(minX,0)), value);
		centerWriter.append(new ClusterCenter(new Vector(maxX,0)), value);
		centerWriter.close();
		final SequenceFile.Writer dataWriter = SequenceFile.createWriter(fs,conf, in, ClusterCenter.class,Vector.class);
	
		dataWriter.append(new ClusterCenter(new Vector(0, 0)), new Vector(20, 0));
		dataWriter.append(new ClusterCenter(new Vector(0, 0)), new Vector(30, 0));
		dataWriter.append(new ClusterCenter(new Vector(0, 0)), new Vector(40, 0));
		dataWriter.append(new ClusterCenter(new Vector(0, 0)), new Vector(50, 0));
		dataWriter.append(new ClusterCenter(new Vector(0, 0)), new Vector(20, 0));
		dataWriter.append(new ClusterCenter(new Vector(0, 0)), new Vector(30, 0));
		dataWriter.append(new ClusterCenter(new Vector(0, 0)), new Vector(40, 0));
		dataWriter.append(new ClusterCenter(new Vector(0, 0)), new Vector(50, 0));
		
		dataWriter.append(new ClusterCenter(new Vector(0, 0)), new Vector(2000, 0));
		dataWriter.append(new ClusterCenter(new Vector(0, 0)), new Vector(3000, 0));
		dataWriter.append(new ClusterCenter(new Vector(0, 0)), new Vector(4000, 0));
		dataWriter.append(new ClusterCenter(new Vector(0, 0)), new Vector(5000, 0));
		dataWriter.append(new ClusterCenter(new Vector(0, 0)), new Vector(2000, 0));
		dataWriter.append(new ClusterCenter(new Vector(0, 0)), new Vector(3000, 0));
		dataWriter.append(new ClusterCenter(new Vector(0, 0)), new Vector(4000, 0));
		dataWriter.append(new ClusterCenter(new Vector(0, 0)), new Vector(5000, 0));
